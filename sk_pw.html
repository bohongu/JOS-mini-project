...
<div class="content_title">기존 비밀번호 입력</div>
<div class="content_content">
    <input type="password" id="password_0" class="pw" placeholder="비밀번호">
    <span>기존 비밀번호를 입력해주세요.</span>
</div>
  
<div class="content_title">신규 비밀번호 입력</div>
<div class="content_content">
    <input type="password" id="password_1" class="pw" placeholder="비밀번호">
    <span>8~15자리의 영문, 숫자, 특수문자의 입력이 가능합니다.</span>
</div>
  
<div class="content_title">신규 비밀번호 재입력</div>
<div class="content_content">
